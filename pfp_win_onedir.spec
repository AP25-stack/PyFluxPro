...
pf_foldr='C:\\Users\\peter\\miniconda3\\envs\\pfp_env\\Library\\plugins\\platforms\\'

a = Analysis(['PyFluxPro.py'],
             pathex=['C:\\Users\\peter\\PyFluxPro'],
             binaries=[],
             datas=[('solo/bin/sofm.exe', 'solo/bin/'),
                    ('solo/bin/solo.exe', 'solo/bin/'),
                    ('solo/bin/seqsolo.exe', 'solo/bin/'),
                    ('mpt/bin/ustar_mp.exe', 'mpt/bin/'),
                    ('mds/bin/gf_mds.exe', 'mds/bin/'),
...
# see https://stackoverflow.com/questions/62625517/pyinstaller-exe-file-terminates-early-without-an-error-message
					('libiomp5md.dll', '.')],
