...
def TRF(data_dict, Eo, rb):
    #tmp0 = 1 / (10 + 46.02)
    #tmp1 = 1 / data_dict #['TempC']
    #result = rb * numpy.exp(Eo * (tmp0 - 1 / (tmp1 + 46.02)))
    #result = rb * numpy.exp(Eo * (1 / (10 + 46.02) - 1 / (data_dict['TempC'] + 46.02)))
    #return result
    return rb * numpy.exp(Eo * (1 / (10 + 46.02) - 1 / (data_dict + 46.02)))
